...
export default class Mur2 extends Component {
    ...
    async getOrientation(){
      ...
      componentDidMount=async() =>{
        ...
        getMurDirection() {
          return sessionStorage.getItem('directionMur4');
        }
        handleChange=(e)=>{
       ...
       name="Latitude" required />
           ...
           <fieldset className='Mur2'>
                ...
                <div className="newUserItemE">
                     ...
                     name="LongueurM3" defaultValue={sessionStorage.getItem('LongueurM3')} onChange={this.handleChange}  />
                </div>
           ...
           <a href="/Mur_3"><button   className="newUserButton">Retour  </button></a>
           <a href="/plafond"><button  onClick={this.AddMur} type="submit"  className="newUserButton">Suivant  </button></a>
