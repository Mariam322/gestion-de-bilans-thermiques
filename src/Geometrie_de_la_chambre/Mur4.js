...
export default class Mur4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            libelle:'',
       ...
       name="Latitude" required />
           ...
           <fieldset className='Mur1'>
                ...
                <div className="newUserItemE">
                     ...
                     name="Longueur" value={sessionStorage.getItem('LongueurM')}  />
                </div>
           ...
           <a href="/Plafond"><button  type="submit"  className="newUserButton">Suivant  </button></a>
