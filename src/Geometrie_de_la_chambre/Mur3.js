       ...
       name="Latitude" required />
           ...
           <fieldset className='Mur2'>
                ...
                <div className="newUserItemE">
                     ...
                     name="Longueur" value={sessionStorage.setItem('LongueurM3',this.state.Longueur)}  onChange={this.handleChange}  />
                </div>
           ...
           <a href="/Mur_2"><button   className="newUserButton">Retour  </button></a>
            <a href="/Mur_4"><button  onClick={this.AddMur} type="submit"  className="newUserButton">Suivant  </button></a>
